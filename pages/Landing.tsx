    ...
    <nav className="fixed top-5 left-1/2 -translate-x-1/2 w-[92%] max-w-6xl z-50">
      <div className="bg-white/70 backdrop-blur-xl border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.04)] rounded-full px-3 pl-6 py-2 flex items-center justify-between transition-all duration-300 hover:bg-white/90 hover:shadow-[0_8px_32px_rgba(0,0,0,0.08)]">
        <div className="flex items-center gap-2 group cursor-pointer">
          ...
          <span className="font-semibold text-lg text-stone-900 tracking-tight">CareerFlow</span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-stone-600">
          ...
          <Link to="/admin/fairness" className="hover:text-stone-900 transition-colors hover:scale-105 transform inline-block">Fairness AI</Link>
        </div>
...
const FloatingWidget_StickyNote = () => (
  <div className="absolute top-20 left-[5%] md:left-[8%] w-40 md:w-48 bg-[#fef08a] rounded-sm shadow-[0_8px_30px_rgb(0,0,0,0.12)] rotate-[-6deg] p-4 md:p-6 font-handwriting transform hover:scale-110 hover:rotate-[-8deg] transition-all duration-300 hidden lg:block z-10 animate-float-slow cursor-help origin-center">
    <div className="w-3 h-3 rounded-full bg-red-400 mx-auto -mt-6 md:-mt-8 mb-4 shadow-sm border border-red-500/20"></div>
    <p className="text-stone-800 font-medium leading-relaxed text-xs md:text-sm">
      Update resume with recent React project metrics.
    </p>
    <p className="text-stone-800 font-medium leading-relaxed text-xs md:text-sm mt-2">
...
const FloatingWidget_Calendar = () => (
  <div className="absolute top-32 right-[5%] md:right-[8%] bg-white p-4 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-stone-100 rotate-[3deg] w-56 md:w-64 hidden lg:block z-10 animate-float-delayed hover:rotate-[0deg] transition-all duration-300 hover:scale-105 cursor-pointer group">
    <div className="flex justify-between items-center mb-4">
      <span className="text-xs font-bold text-stone-400 uppercase tracking-wider">Reminders</span>
      <div className="w-2 h-2 rounded-full bg-red-400 animate-pulse group-hover:scale-150 transition-transform"></div>
    </div>
    <div className="bg-stone-50 rounded-xl p-3 mb-2 border border-stone-100 group-hover:bg-stone-100 transition-colors">
      <p className="text-xs text-stone-500 mb-1">Today's Interview</p>
      <p className="text-sm font-medium text-stone-800">Product Manager Role</p>
      <div className="flex items-center gap-2 mt-2 text-xs text-sage-600 bg-sage-50 px-2 py-1 rounded w-fit">
...
const FloatingWidget_Tasks = () => (
  <div className="absolute bottom-20 left-[10%] lg:left-[15%] bg-white p-5 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-stone-100 rotate-[2deg] w-64 md:w-72 hidden xl:block z-10 animate-float hover:rotate-[0deg] transition-all duration-300 hover:scale-105 cursor-default">
    <p className="font-semibold text-stone-800 mb-4 flex items-center gap-2">
      <CheckSquare size={16} className="text-sage-500" /> Today's tasks
    </p>
    <div className="space-y-4">
      <div className="group cursor-pointer">
        <div className="flex justify-between text-xs mb-1">
          <span className="font-medium text-stone-700 group-hover:text-sage-700 transition-colors">Refine Portfolio</span>
          <span className="text-stone-400">60%</span>
        </div>
        <div className="h-1.5 w-full bg-stone-100 rounded-full overflow-hidden">
          <div className="h-full bg-sage-500 w-[60%] rounded-full group-hover:bg-sage-600 transition-colors"></div>
        </div>
      </div>
      <div className="group cursor-pointer">
        <div className="flex justify-between text-xs mb-1">
          <span className="font-medium text-stone-700 group-hover:text-blue-700 transition-colors">SQL Certification</span>
...
const FloatingWidget_Integrations = () => (
  <div className="absolute bottom-32 right-[10%] lg:right-[15%] bg-white p-5 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-stone-100 -rotate-[3deg] w-fit hidden xl:block z-10 animate-float-slow hover:rotate-[0deg] transition-all duration-300 hover:scale-110 cursor-pointer">
    <p className="text-xs font-medium text-stone-500 mb-3">100+ Integrations</p>
    <div className="flex items-center gap-3">
      <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 hover:bg-blue-100 transition-colors hover:scale-110"><Linkedin size={20} /></div>
      <div className="w-10 h-10 bg-orange-50 rounded-xl flex items-center justify-center text-orange-600 hover:bg-orange-100 transition-colors hover:scale-110"><Mail size={20} /></div>
      <div className="w-10 h-10 bg-emerald-50 rounded-xl flex items-center justify-center text-emerald-600 hover:bg-emerald-100 transition-colors hover:scale-110"><Github size={20} /></div>
    </div>
  </div>
);
...
const Hero = () => {
  return (
    <section className="relative pt-32 pb-20 md:pt-36 md:pb-28 overflow-hidden px-4">
      <DotPattern />
      ...
      <div className="relative z-20 max-w-4xl mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-7xl font-medium text-stone-900 tracking-tight leading-[1.1] mb-6 md:mb-8">
          Think, plan, and build <br className="hidden md:block" />
          <span className="text-stone-400">your career in one place</span>
        </h1>

        <p className="text-lg md:text-xl text-stone-500 max-w-xl mx-auto mb-8 md:mb-12 leading-relaxed px-4">
          Efficiently manage your resume, track skill gaps, and find the perfect role with AI-driven guidance.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            to="/student/dashboard"
            className="w-full sm:w-auto px-8 py-4 bg-sage-600 text-white rounded-2xl font-medium text-lg hover:bg-sage-700 transition-all shadow-lg shadow-sage-200 hover:shadow-sage-300 hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2 group"
          >
            I'm a Student
          ...
          <Link
            ...
            className="w-full sm:w-auto px-8 py-4 bg-white text-stone-700 border border-stone-200 rounded-2xl font-medium text-lg hover:bg-stone-50 hover:border-stone-300 transition-all shadow-sm hover:shadow-md hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2"
          >
            I'm a Recruiter
          </Link>
        </div>
...
const Landing: React.FC = () => {
  return (
    <div className="bg-white min-h-screen font-sans text-stone-900 selection:bg-sage-100 overflow-x-hidden">
